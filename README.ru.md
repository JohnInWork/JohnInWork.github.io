...
Одна статическая страница: HTML, CSS и около 60 строк JavaScript — без сборки и зависимостей. Вертикальный скролл ведёт горизонтальную ленту панелей, акцентный цвет каждой игры взят из самой игры. На телефоне сворачивается в обычную колонку, при системном запросе на меньше движения инерция отключается.
