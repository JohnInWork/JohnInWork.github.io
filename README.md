...
A single static page: HTML, CSS and about 60 lines of JavaScript — no build step, no dependencies. Vertical scrolling drives a horizontal rail of panels; each game's accent colour is taken from the game itself. Collapses to a normal column on phones and drops the inertia when the system asks for reduced motion.
